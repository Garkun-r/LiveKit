...
VOICE_SIP_PARTICIPANT_WAIT_TIMEOUT_SEC = float(
    os.getenv("VOICE_SIP_PARTICIPANT_WAIT_TIMEOUT_SEC", "12.0")
)
VOICE_AUDIO_OUTPUT_READY_TIMEOUT_SEC = float(
    os.getenv("VOICE_AUDIO_OUTPUT_READY_TIMEOUT_SEC", "4.0")
)
VOICE_PRERECORDED_PLAYOUT_GRACE_SEC = float(
    os.getenv("VOICE_PRERECORDED_PLAYOUT_GRACE_SEC", "1.5")
)
VOICE_PRERECORDED_MIN_PLAYOUT_TIMEOUT_SEC = float(
    os.getenv("VOICE_PRERECORDED_MIN_PLAYOUT_TIMEOUT_SEC", "2.5")
)
VOICE_PRERECORDED_PLAYOUT_RETRIES = max(
    0,
    int(os.getenv("VOICE_PRERECORDED_PLAYOUT_RETRIES", "1")),
)
VOICE_STARTUP_NO_DIALOG_TIMEOUT_SEC = float(
    os.getenv("VOICE_STARTUP_NO_DIALOG_TIMEOUT_SEC", "12.0")
)
...
VOICE_CLIENT_SILENCE_SECOND_AUDIO_PATH = os.getenv(
...
VOICE_CLIENT_SILENCE_FIRST_SEC = float(
    os.getenv("VOICE_CLIENT_SILENCE_FIRST_SEC", "5.0")
)
VOICE_CLIENT_SILENCE_SEC = float(os.getenv("VOICE_CLIENT_SILENCE_SEC", "4.0"))
VOICE_CLIENT_SILENCE_STT_GRACE_SEC = float(
    os.getenv("VOICE_CLIENT_SILENCE_STT_GRACE_SEC", "1.0")
)
